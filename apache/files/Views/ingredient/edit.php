...
<form class="form" action="<?= $controller->getUrl('?controller=EditIngredient&action=save') ?>" enctype="multipart/form-data" method="post">
    ...
    <div id="amount2ingredient">
        ...
        <?php } else { ?>
            <div class="card card-body w-50 mx-auto mb-2">
                <div class="row w-50 mx-auto form-floating mb-2">
                    <input class="col-12 form-control" name="buyOption[0][price]" type="text" placeholder="" required>
                    <label>Preis</label>
                </div>
                <div class="row w-50 mx-auto form-floating mb-2">
                    <input class="col-12 form-control" name="buyOption[0][amount]" type="text" placeholder="" required>
                    <label>Menge</label>
                </div>
                <div class="row w-50 mx-auto">
    ...
    <div>
        <div class="mx-auto w-50 d-flex justify-content-between">
            <button id="addBuy" class="btn btn-primary" type="button">Kaufoption hinzufügen</button>
