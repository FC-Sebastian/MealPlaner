        ...
        <script src="<?= $controller->getUrl("lib/chart/chart.min.js") ?>"></script>
        <script src="<?= $controller->getUrl("lib/easing/easing.min.js") ?>"></script>
        <script src="<?= $controller->getUrl("lib/waypoints/waypoints.min.js") ?>"></script>
        <script src="<?= $controller->getUrl("lib/owlcarousel/owl.carousel.min.js") ?>"></script>
